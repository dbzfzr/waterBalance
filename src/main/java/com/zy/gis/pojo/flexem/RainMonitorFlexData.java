...
@description TODO 雨水监测点数据实体类
*/
public class RainMonitorFlexData implements Serializable {
    /**
     * 记录id
     */
    private Integer id;
    ...
    /**
     * 当前雨量 mm/h
     * @return current_rainfall 当前雨量 mm/h
     */
    ...
    /**
     * 当前雨量 mm/h
     * @param currentRainfall 当前雨量 mm/h
     */
    public void setCurrentRainfall(String currentRainfall) {
        this.currentRainfall = currentRainfall == null ? null : currentRainfall.trim();
    }
