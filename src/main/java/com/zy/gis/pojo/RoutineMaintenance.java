...
@description TODO 日常维护记录信息类
*/
public class RoutineMaintenance implements Serializable {
    /**
     * 记录id
     */
    private Integer id;
     ...
     * 维护的具体内容字符串
     */
    private String maintenanceArrayStr;
    ...
    /**
     * 维护的具体内容字符串
     * @return maintenance_array_str 维护的具体内容字符串
     */
    public String getMaintenanceArrayStr() {
        return maintenanceArrayStr;
    }

    /**
     * 维护的具体内容字符串
     * @param maintenanceArrayStr 维护的具体内容字符串
     */
    public void setMaintenanceArrayStr(String maintenanceArrayStr) {
        this.maintenanceArrayStr = maintenanceArrayStr == null ? null : maintenanceArrayStr.trim();
    }
