    ...
    function load() {
        ...
        var libsConfig = {
            ...
            'cesium-gsp': [
                ...
                // libpath + "cesium-gsp/gsp3d.css",
                // libpath + "cesium-gsp/gsp3d.js",
                // libpath + "CesiumPlugins/esri/gsp3d-esri.js", //arcgis矢量图层扩展，无此需求时注释即可

            ],
            'leaflet-gsp': [
                libpath + "leaflet-gsp/leaflet.css",
                libpath + "leaflet-gsp/leaflet.js",
            ],
            'Geocoder': [
                libpath + "Geocoder/Geocoder.css",
                libpath + "Geocoder/Geocoder.js",
                libpath + "Geocoder/GeocoderViewModel.js",
                
            ],

            'dh3dmapjs':[
                libpath + "dh3dmapjs/multDataSource.js",
                libpath + "dh3dmapjs/sceneDrawManagers.js",
                libpath + "dh3dmapjs/sceneRoam.js",
                libpath + "dh3dmapjs/mapToolBox.js",
                libpath + "dh3dmapjs/spatialAnalysis.js",
                libpath + "dh3dmapjs/mapSceneManager.js",
                libpath + "dh3dmapjs/drawCircular.js",
                libpath + "dh3dmapjs/sceneEffects.js",            
                libpath + "dh3dmapjs/dataAnalysis.js",
                // libpath + "dh3dmapjs/sceneManager.js",
            ]
        };
