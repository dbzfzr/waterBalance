...
(function() {
     ...
     * @constructor
     */
    BMapGLLib.DrawingState = function(map, state){
      if(state){
          drawingManager.setDrawingMode(BMAP_DRAWING_POLYGON);//绘制类型为"多边形"
          drawingManager.open();//开启绘制
          drawingManager._map.disableDoubleClickZoom();//开启地图绘制
          drawingManager.clearOverlays();//清空覆盖物
      }else{
